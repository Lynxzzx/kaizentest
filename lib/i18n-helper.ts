...
export const translations: Record<string, Record<string, string>> = {
  'pt-BR': {
    ...
    'comingSoon': 'Em breve',
    'cardPaymentDescription': 'Preencha os dados do seu cartão de crédito para efetuar o pagamento.',
    'cardNumber': 'Número do Cartão',
    'expMonth': 'Mês',
    'expYear': 'Ano',
    'cardHolderName': 'Nome no Cartão',
    'cardHolderNamePlaceholder': 'NOME COMO ESTÁ NO CARTÃO',
    'cardSecurityNotice': 'Seus dados estão protegidos com criptografia SSL.',
    'cardSecurityNoticeTokenized': 'Seus dados do cartão são processados diretamente pelo PagBank. Nenhum dado sensível é armazenado em nossos servidores.',
    'securePayment': 'Pagamento Seguro',
    'pciCompliant': 'PCI Compliant',
    'sslEncrypted': 'Criptografado SSL',
    'pagbankSecure': 'Processado pelo PagBank',
    'tokenizingCard': 'Tokenizando cartão...',
    'cardTokenized': 'Cartão tokenizado com sucesso',
    'tokenizationError': 'Erro ao tokenizar cartão. Tente novamente.',
    'payNow': 'Pagar Agora',
    'processing': 'Processando...',
    'cardPaymentApproved': 'Pagamento aprovado! Seu plano foi ativado.',
    'cardPaymentPending': 'Pagamento em análise. Aguarde a confirmação.',
    'cardPaymentError': 'Erro ao processar o pagamento. Tente novamente.',
    'invalidCardNumber': 'Número do cartão inválido.',
    'invalidExpMonth': 'Mês de validade inválido.',
    'invalidExpYear': 'Ano de validade inválido.',
    'invalidCvv': 'CVV inválido.',
    'invalidCardHolderName': 'Nome no cartão inválido.',
    ...
    'selectLanguageDescription': 'Escolha o idioma que você fala para que possamos atendê-lo melhor no Telegram.',
    'yourLanguage': 'Seu idioma',
    'otherLanguage': 'Outro idioma',
    'payManualInternational': 'Pagamento Manual (Internacional)',
    'manualPaymentInternational': 'Pagamento Manual Internacional',
    'manualPaymentDescription': 'Para usuários que não são do Brasil, oferecemos pagamento manual via Telegram. Aceitamos Wise e qualquer criptomoeda.',
    'acceptedPaymentMethods': 'Métodos de pagamento aceitos:',
    'wiseDescription': 'Transferência bancária internacional via Wise',
    'anyCryptocurrency': 'Qualquer Criptomoeda',
    'cryptoDescription': 'Bitcoin, Ethereum, USDT e outras criptomoedas',
    'manualPaymentInstructions': 'Clique no botão abaixo para abrir o Telegram. Envie uma mensagem informando o plano desejado e o método de pagamento que prefere usar. Responderemos rapidamente com as instruções de pagamento.'
  },
  'en': {
    'siteName': 'Kaizen Gens',
    'login': 'Login',
    ...
    'plansDescription': 'Choose the perfect plan for you and get access to all our premium services',
    ...
    'payViaCard': 'Pay via Credit Card',
    'comingSoon': 'Coming soon',
    'cardPaymentDescription': 'Enter your credit card information securely. Your payment is processed directly by PagBank with bank-level encryption.',
    'cardNumber': 'Card Number',
    'expMonth': 'Month',
    'expYear': 'Year',
    'cardHolderName': 'Cardholder Name',
    'cardHolderNamePlaceholder': 'NAME AS ON CARD',
    'cardSecurityNotice': 'Your data is protected with SSL encryption.',
    'cardSecurityNoticeTokenized': 'Your card data is processed directly by PagBank. No sensitive data is stored on our servers.',
    'securePayment': 'Secure Payment',
    'pciCompliant': 'PCI Compliant',
    'sslEncrypted': 'SSL Encrypted',
    'pagbankSecure': 'Processed by PagBank',
    'tokenizingCard': 'Tokenizing card...',
    'cardTokenized': 'Card tokenized successfully',
    'tokenizationError': 'Error tokenizing card. Please try again.',
    'payNow': 'Pay Now',
    'processing': 'Processing...',
    'cardPaymentApproved': 'Payment approved! Your plan has been activated.',
    'cardPaymentPending': 'Payment under review. Please wait for confirmation.',
    'cardPaymentError': 'Error processing payment. Please try again.',
    ...
    'emailRequired': 'A valid email is required to process PIX payments. This email will only be used for transaction purposes and will not be stored.',
    'emailLabel': 'Email *',
    ...
    'instructionsText': 'Scan the QR Code with your banking app or copy and paste the PIX code to complete the payment.',
    'autoActivation': '✨ Automatic Activation:',
    'autoActivationText': 'Our system automatically checks for payment confirmation every 5 seconds. Once your payment is confirmed, your plan will be activated immediately!',
    ...
    'importantText': 'Please double-check the address before sending. Cryptocurrency transactions are irreversible and cannot be refunded.',
    'attention': 'Attention:',
    'autoPaymentUnavailable': 'The automatic payment system is temporarily unavailable.',
    'contactTelegram': 'Please contact us via Telegram to complete your payment:',
    'openTelegram': 'Open Telegram',
    'joinTelegram': 'Join Telegram',
    'joinDiscord': 'Join Discord',
    'freeKeys': 'Join our Telegram and Discord communities! We regularly release free access keys to the generator and much more exclusive content.',
    'or': 'or',
    ...
    'errorCreatingPayment': 'An error occurred while creating the payment. Please try again or contact support if the problem persists.',
    'errorInvalidEmail': 'Please enter a valid email',
    'errorIncompletePaymentData': 'Error: Payment data is incomplete. Please try again or contact support for assistance.',
    ...
    'selectLanguageDescription': 'Choose the language you speak so we can assist you better on Telegram.',
    'yourLanguage': 'Your language',
    'otherLanguage': 'Other language',
    'payManualInternational': 'Manual Payment (International)',
    'manualPaymentInternational': 'International Manual Payment',
    'manualPaymentDescription': 'For users outside Brazil, we offer manual payment via Telegram. We accept Wise and any cryptocurrency.',
    'acceptedPaymentMethods': 'Accepted payment methods:',
    'wiseDescription': 'International bank transfer via Wise',
    'anyCryptocurrency': 'Any Cryptocurrency',
    'cryptoDescription': 'Bitcoin, Ethereum, USDT and other cryptocurrencies',
    'manualPaymentInstructions': 'Click the button below to open Telegram. Send a message informing the desired plan and the payment method you prefer to use. We will respond quickly with payment instructions.'
  }
}
