      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2 flex items-center gap-3">
            <span>🎄</span>
            <span>Configuração Natalina</span>
            <span>🎅</span>
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Ative ou desative as decorações natalinas do site para todos os usuários
          </p>
        </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">
                    {isChristmasMode ? 'Ativado para todos os usuários' : 'Desativado'}
                  </p>
                </div>
              </div>
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>Árvores de Natal decorativas nos cantos</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-lg">💡</span>
                ...
                <li className="flex items-center gap-2">
                  <span className="text-lg">🎁</span>
                  <span>Ícones festivos (presentes, Papai Noel)</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-lg">🎅</span>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className={`text-sm ${isChristmasMode ? 'text-white' : 'text-gray-500'}`}>
                      {isChristmasMode ? 'Decorações ativas!' : 'Decorações desativadas'}
                    </p>
                  </div>
                </div>
                {isChristmasMode && (
        ...
        <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl">
          ...
          <ul className="text-sm text-yellow-800 dark:text-yellow-300 space-y-1">
            <li>• Quando ativo, todos os usuários verão as decorações automaticamente</li>
            <li>• Os efeitos são leves e não impactam a performance do site</li>
            <li>• Pode ser desativado a qualquer momento</li>
            <li>• Perfeito para o período de festas (dezembro/janeiro)</li>
          </ul>
        </div>
      </div>
    </Layout>
